...
contract FarmProductTracking {
    struct Product {
        ...
        string category;
        string subCategory;
        string iotDeviceNumber; // New field added
        address owner;
    }
    ...
    event ProductAdded(
        ...
        string category,
        string subCategory,
        string iotDeviceNumber, // Updated event
        address owner
    );
    ...
    function addProduct(
        ...
        string memory _iotDeviceNumber, // New parameter added
        address _owner
    ) external {
        ...
        products[productCount] = Product(
            ...
            _category,
            _subCategory,
            _iotDeviceNumber, // Save the new input
            _owner
        );
        emit ProductAdded(
            productCount,
            ...
            _category,
            _subCategory,
            _iotDeviceNumber, // Emit the new input
            _owner
        );
    }
